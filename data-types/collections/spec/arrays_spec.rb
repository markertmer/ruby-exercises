...
RSpec.describe 'Arrays' do
  ...
  it 'test 9' do
    ...
    #expect(teams).to eq(["Rockies", "Avalanche", "Nuggets", "Broncos", "Rapids"])
  ...
  it 'test 12' do
    ...
    new_scores = scores.insert(4, scores.delete_at(0)).insert(4, scores.delete_at(0))
    ...
    scores = [23, 56, 34, 29, 48]
    new_scores = scores.insert(0, scores.delete_at(4))
