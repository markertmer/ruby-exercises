RSpec.describe 'reject' do
  ...
  it 'remove dinosaurs' do
    ...
    notasaurus = animals.reject do |anm|
      anm.include? "saurus"
    end
  ...
  it 'remove numbers' do
    ...
    not_numbers = elements.reject do |elm|
      elm.kind_of? Numeric
    end
  ...
  it 'remove animals starting with a vowel' do
    ...
    remaining = animals.reject do |anm|
      anm[0][/[aeiouy]/]
    end
  ...
  it 'remove arrays' do
    ...
    remaining = elements.reject do |elm|
      elm.kind_of? Array
    end
