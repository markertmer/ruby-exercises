RSpec.describe 'All Pattern' do
  ...
  it 'not all uppercase' do
    ...
    all_caps = true
    words.each do |wrd|
      all_caps = false unless wrd == wrd.upcase
    end
  ...
  it 'not all 3 digits long' do
    ...
    all_3_digits = true
    numbers.each do |num|
      all_3_digits = false unless num.to_s.count(num.to_s) == 3
    end
  ...
  it 'all four letter words' do
    ...
    all_4_letters = true
    words.each do |wrd|
      all_4_letters = false unless wrd.length == 4
    end
