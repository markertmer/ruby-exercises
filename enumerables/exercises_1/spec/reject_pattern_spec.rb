RSpec.describe 'reject pattern' do
  ...
  it 'removes words longer than 3 letters' do
    ...
    selected = []
    words.each do |wrd|
      selected << wrd unless wrd.count(wrd) > 3
    end
  ...
  it 'removes words ending in ing' do
    ...
    selected = []
    words.each do |wrd|
      selected << wrd unless wrd[-3..-1] == "ing"
    end
  ...
  it 'removes words containing e' do
    ...
    selected = []
    words.each do |wrd|
      selected << wrd unless wrd.include? "e"
    end
  ...
  it 'removes dinosaurs' do
    ...
    notasaurus = []
    animals.each do |anm|
      notasaurus << anm unless anm.include? "saurus"
    end
  ...
  it 'removes numbers' do
    ...
    elements.each do |elm|
      not_numbers << elm unless elm.kind_of? Numeric
    end
  ...
  it 'removes floats' do
    ...
    not_numbers = []
    elements.each do |elm|
      not_numbers << elm unless elm.kind_of? Float
    end
  ...
  it 'removes animals starting with vowels' do
    ...
    remaining = []
    animals.each do |anm|
      #remaining << anm unless anm[0].include? anm[/[aeiouy]/]
      remaining << anm unless anm[0][/[aeiouy]/]
    end
  ...
  it 'removes upcased words' do
    ...
    remaining = []
    words.each do |wrd|
      remaining << wrd unless wrd == wrd.upcase
    end
  ...
  it 'removes arrays' do
    ...
    remaining = []
    elements.each do |elm|
      remaining << elm unless elm.kind_of? Array
    end
  ...
  it 'removes hashes' do
    ...
    remaining = []
    elements.each do |elm|
      remaining << elm unless elm.kind_of? Hash
    end
