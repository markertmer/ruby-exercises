RSpec.describe 'select pattern' do
  ...
  it 'words with three letters' do
    ...
    selected = []
    words.each do |word|
      selected << word if word.count(word) == 3
    end
  ...
  it 'words with more than three letters' do
    ...
    selected = []
    words.each do |turd|
      selected << turd if turd.count(turd) > 3
    end
  ...
  it 'words ending in ing' do
    ...
    words.each do |element|
      selected << element if element[-3..-1] == "ing"
    end
  ...
  it 'dinosaurs' do
    ...
    dinosaurs = []
    animals.each do |creature|
      dinosaurs << creature if creature.include?("saurus")
    end
  ...
  it 'floats' do
    ...
    floats = []
    numbers.each do |num|
      floats << num if num.kind_of? Float
    end
  ...
  it 'arrays' do
    ...
    elements.each do |elem|
      arrays << elem if elem.kind_of? Array
    end
  ...
  it 'hashes' do
    ...
    hashes = []
    elements.each do |elem|
      hashes << elem if elem.kind_of? Hash
    end
